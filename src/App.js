...
const DICTIONARY = {
  en: {
    ...
    hero_title: 'Professional Grade AI for Uzbekistan’s Legal Sector.',
  ...
  ru: {
    ...
    hero_title: 'Профессиональный ИИ для Юридического Сектора Узбекистана.',
  ...
  uz: {
    ...
    hero_title: 'O\'zbekistonning Yuridik Sektori Uchun Professional AI.',
